...
public class LocationModel {
    ...
    public static ArrayList<FLWLocation> getLocations() {
        ...
        locations.add(1, new FLWLocation(R.string.wingspread, R.mipmap.wingspread, R.drawable.marker_orange));
        locations.add(2, new FLWLocation(R.string.monona_terrace, R.mipmap.monona_terrace, R.drawable.marker_yellow));
